...
@class CGenGFPortBoolean, CGenGFVirtualPort, NSMutableString;

@interface CGenGFModuleLog : CGenGFModule
{
    CGenGFVirtualPort *inputValue;
    CGenGFPortBoolean *inputLogToConsole;
    CGenGFPortBoolean *inputLogToUI;
