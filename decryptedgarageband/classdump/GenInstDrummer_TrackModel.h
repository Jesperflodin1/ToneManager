...
@interface GenInstDrummer_TrackModel : NSObject <GenInstDrummer_TrackModelProtocol>
{
    ...
    _Bool mLoadProducerKitIfAvailable;
...
- (_Bool)loadPatchForURLIntern:(id)arg1 options:(id)arg2;
- (_Bool)loadPatchForSelectedCharacterAtIndex:(unsigned long long)arg1;
- (_Bool)loadPatchForURL:(id)arg1 options:(id)arg2;
- (_Bool)loadDefaultPatchForSelectedCharacterIdentifier;
...
- (void)setParametersWhereChangedAfterCharacterRecallIntern:(_Bool)arg1;
- (void)setParametersWhereChangedAfterCharacterRecall:(_Bool)arg1;
- (_Bool)keepDrumKitWhenChangingDrummer;
- (void)setKeepDrumKitWhenChangingDrummerIntern:(_Bool)arg1;
- (void)setKeepDrumKitWhenChangingDrummer:(_Bool)arg1;
- (_Bool)keepSettingsWhenChangingDrummer;
- (void)setKeepSettingsWhenChangingDrummerIntern:(_Bool)arg1;
- (void)setKeepSettingsWhenChangingDrummer:(_Bool)arg1;
- (void)setKeepSettingsWhenChangingDrummer:(_Bool)arg1 parameterKeysToKeep:(id)arg2;
- (id)drummerModel;
