...
- (id)state;
- (_Bool)songHasOnlyOneDrummerTrackWithContentAndOnlyOtherEmptyTracksForChangeOnTrack:(struct TTrackNr)arg1;
- (_Bool)drumTrackExists;
- (_Bool)allowCreationOfAdditionalAnimalTrack;
