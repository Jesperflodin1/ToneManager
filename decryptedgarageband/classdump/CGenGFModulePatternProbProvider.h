...
@class CGenGFPortPatternAndProbs, NSMutableArray;

@interface CGenGFModulePatternProbProvider : CGenGFModule
{
    CGenGFPortPatternAndProbs *outputPatterns;
    NSMutableArray *patternPoolIdentifiers;
}

+ (_Bool)allowsSubpatchesWithIdentifier:(id)arg1;
+ (int)executionModeWithIdentifier:(id)arg1;
- (void).cxx_destruct;
- (id)patternPoolIdentifiers;
- (void)setPatternPoolIdentifiers:(id)arg1;
- (void)dealloc;
