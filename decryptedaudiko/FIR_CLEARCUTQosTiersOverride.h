...
@interface FIR_CLEARCUTQosTiersOverride : GSDK_PBGeneratedMessage
{
}
...
@property(retain, nonatomic) GSDK_PBMutableArray *qosTierConfigurationArray; // @dynamic qosTierConfigurationArray;
