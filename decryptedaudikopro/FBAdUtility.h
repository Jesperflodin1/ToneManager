...
+ (void)startObservingNotifications:(id)arg1 usingBackgroundBlock:(CDUnknownBlockType)arg2 usingForegroundBlock:(CDUnknownBlockType)arg3;
...
+ (void)addGaussianBlurToImages:(id)arg1 withBlock:(CDUnknownBlockType)arg2;
+ (id)blurImage:(id)arg1 withRadius:(double)arg2;
+ (id)addGaussianBlurToImage:(id)arg1;
